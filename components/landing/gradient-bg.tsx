...
>) {
    return (
        ...
        >
            ...
            <div
                className={cn(
                    "flex-none inset-0 overflow-hidden absolute z-0 rounded-none bg-gradient-to-tl dark:from-dragonfly-primary/30 dark:via-zinc-900 dark:to-black blur-md opacity-50",
                )}
            />
