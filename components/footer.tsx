...
export default function Footer() {
    return (
        <footer className="w-full border-t border-zinc-200 dark:border-zinc-800 bg-white dark:bg-black backdrop-blur-xl">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    {/* Brand */}
                    <div className="col-span-1">
                        <div className="flex items-center gap-2 mb-4">
                            {/* Dragonfly-inspired icon */}
                            <Image
                        ...
                        <p className="text-sm text-zinc-600 dark:text-zinc-400">
                            High-performance Minecraft Bedrock Edition server written in Go.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            ...
                            <li>
                                <Link
                                    href="https://github.com/df-mc/dragonfly/issues"
                                    target="_blank"
                                    className="text-sm text-zinc-600 hover:text-cyan-600 dark:text-zinc-400 dark:hover:text-cyan-400 transition-colors duration-200"
                                >
                                    Issues
                ...
                <div className="mt-12 pt-8 border-t border-zinc-200 dark:border-zinc-800">
                    <div className="flex flex-col md:flex-row justify-between items-center gap-4">
                        <p className="text-sm text-zinc-600 dark:text-zinc-400">
                            © {new Date().getFullYear()} Dragonfly. Licensed under MIT.
                        </p>
                        <div className="flex items-center gap-6">
                            <Link
                                href="https://github.com/df-mc/dragonfly"
                                target="_blank"
                                className="text-zinc-600 hover:text-cyan-600 dark:text-zinc-400 dark:hover:text-cyan-400 transition-colors duration-200"
                                aria-label="GitHub"
                            >
